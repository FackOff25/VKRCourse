...
Эта задача относится к классу NP-сложных задач \cite{NP-problems}, что обуславливает необходимость использования эвристических подходов, среди которых алгоритм Кернигана-Лина занимает важное место \cite{Fennel}.
...
\subsubsection{Класс оптимизатора (optimizer.hpp)}
...
\textbf{Структура класса оптимизатора}
...
\textbf{Основной метод расчёта метрик}
...
\begin{center}
    ...
    \captionof{figure}{Оптимизированный граф}
